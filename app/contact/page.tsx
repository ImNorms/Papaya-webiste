          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <ScrollReveal animation="slide-right" delay={300}>
              <div className="bg-gray-50 rounded-xl p-6 h-[600px] flex flex-col">
                ...
                {/* Chat Messages */}
                <div className="flex-1 overflow-y-auto bg-white rounded-lg p-4 space-y-3 mb-4">
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <button
                      onClick={() => {
                        setInputMessage("What programs do you offer?");
                        handleSendMessage();
                      }}
                    ...
                    <button
                      onClick={() => {
                        setInputMessage("How can I donate?");
                        handleSendMessage();
                      }}
                      className="text-xs bg-papaya-yellow text-papaya-green px-3 py-1 rounded-full hover:bg-opacity-80 transition-colors"
                    >
                    ...
                    <button
                      onClick={() => {
                        setInputMessage("How do I enroll my child?");
                        handleSendMessage();
                      }}
                      className="text-xs bg-papaya-yellow text-papaya-green px-3 py-1 rounded-full hover:bg-opacity-80 transition-colors"
                    >
                    ...
                    <button
                      onClick={() => {
                        setInputMessage("How can I volunteer?");
                        handleSendMessage();
                      }}
                      className="text-xs bg-papaya-yellow text-papaya-green px-3 py-1 rounded-full hover:bg-opacity-80 transition-colors"
                    >
